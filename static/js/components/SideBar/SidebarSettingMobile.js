      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4 ">
        ...
        >
          <CloseButton
            ...
            style={{
              zIndex: 2,
              display: showSidebarSetting ? "block" : "none",
            }}
          ></CloseButton>

          <div className="sidebar-setting-mobile" style={{ height: "100vh" }}>
            <div style={{ width: "100%" }}>
              <ul
              ...
              >
                ...
                <li
                  className="sidebar-list__item coming-soon"
                  onClick={() => {
                    setShowSidebarSetting(false);
                  }}
                >
                ...
                {config.IS_MINIAPP ? null : (
                  ...
                  >
                    <Link
                      ...
                      className={
                        location.pathname ===
                        "/setting-full/link-social-network"
                          ? "is-active"
                          : " "
                      }
                      style={{ display: "flex", gap: 5 }}
...
export default SidebarSettingMobile;
