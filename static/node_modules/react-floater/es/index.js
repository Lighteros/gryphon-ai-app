 ...
 */ function log(_ref) {
  ...
  /* eslint-disable no-console */ var logFn = warn
    ? console.warn || console.error
    : console.log;
  if (debug && title && data) {
    console.groupCollapsed(
      "%creact-floater: ".concat(title),
  ...
  _createClass(ReactFloaterPortal, [
    ...
    },
    {
      ...
      value: function renderPortal() {
        ...
        /* istanbul ignore else */ if (isReact16) {
          return /*#__PURE__*/ ReactDOM.createPortal(children, this.node);
        }
        var portal = ReactDOM.unstable_renderSubtreeIntoContainer(
          this,
          children.length > 1
  ...
  _createClass(FloaterArrow, [
    {
      ...
      get: function get() {
        ...
        /* istanbul ignore else */ if (placement.startsWith("top")) {
          arrow.bottom = 0;
          arrow.left = 0;
          arrow.right = 0;
          arrow.height = length;
...
function FloaterContainer(_ref) {
  var content = _ref.content,
    ...
    styles = _ref.styles;
  var output = {
    content: /*#__PURE__*/ React.isValidElement(content)
      ? content
      : /*#__PURE__*/ React.createElement(
          "div",
  ...
  if (title) {
    output.title = /*#__PURE__*/ React.isValidElement(title)
      ? title
      : /*#__PURE__*/ React.createElement(
          "div",
  ...
  if (footer) {
    output.footer = /*#__PURE__*/ React.isValidElement(footer)
      ? footer
      : /*#__PURE__*/ React.createElement(
          "div",
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (component) {
          ...
          output.content = /*#__PURE__*/ React.createElement(
            FloaterContainer,
            this.props
          );
        }
        ...
        if (!hideArrow) {
          output.arrow = /*#__PURE__*/ React.createElement(
            FloaterArrow,
            this.props
          );
        }
  ...
  _createClass(ReactFloaterWrapper, [
    {
      ...
      value: function render() {
        var _this$props = this.props,
          ...
          styles = _this$props.styles;
        var element;
        /* istanbul ignore else */ if (children) {
...
var ReactFloater = /*#__PURE__*/ (function (_React$Component) {
  ...
  function ReactFloater(props) {
    ...
    /* istanbul ignore else */ _defineProperty(
    ...
    _defineProperty(
      ...
      function () {
        ...
        /* istanbul ignore else */ if (_this.wrapperPopper) {
    ...
    _defineProperty(
      ...
      function () {
        ...
        /* istanbul ignore else */ if (_this.event === "hover") {
          log({
            title: "mouseLeave",
            data: [{ key: "originalEvent", value: event }],
            debug: _this.debug,
          ...
          if (!eventDelay) {
            ...
            [STATUS.OPENING, STATUS.OPEN].indexOf(status) !== -1 &&
            !positionWrapper &&
  ...
  _createClass(ReactFloater, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        if (changed("status", STATUS.IDLE) && open) {
          ...
          changedFrom("status", STATUS.INIT, STATUS.IDLE) &&
          autoOpen
        ) {
          this.toggle(STATUS.OPEN);
        }
        ...
        if (
          this.floaterRef &&
          (changed("status", STATUS.OPENING) ||
            changed("status", STATUS.CLOSING))
        ) {
    ...
    },
    {
      ...
      value: function initPopper() {
        ...
        /* istanbul ignore else */ if (placement === "center") {
        ...
        if (positionWrapper) {
          var wrapperOffset = !is.undefined(wrapperOptions.offset)
    ...
    },
    {
      ...
      value: function toggle(forceStatus) {
        ...
        var nextStatus =
          status === STATUS.OPEN ? STATUS.CLOSING : STATUS.OPENING;
    ...
    },
    {
      ...
      get: function get() {
        ...
        if (positionWrapper) {
          var wrapperStyles;
          if (
            !([STATUS.IDLE].indexOf(status) !== -1) ||
            !([STATUS.IDLE].indexOf(statusWrapper) !== -1)
          ) {
        ...
        /* istanbul ignore else */ if (this.target) {
          var targetStyles = window.getComputedStyle(this.target);
          /* istanbul ignore else */ if (this.wrapperStyles) {
            nextStyles.wrapper = _objectSpread2(
              _objectSpread2({}, nextStyles.wrapper),
              this.wrapperStyles
            );
          } else if (
            !(["relative", "static"].indexOf(targetStyles.position) !== -1)
          ) {
            this.wrapperStyles = {};
            if (!positionWrapper) {
    ...
    },
    {
      ...
      value: function render() {
        ...
        var wrapper = /*#__PURE__*/ React.createElement(
          ReactFloaterWrapper,
          {
