  ...
  _createClass(LocalizedStrings, [
    {
      ...
      value: function setContent(props) {
        ...
        this._props = props;
        utils.validateTranslationKeys(
          Object.keys(props[this._defaultLanguage])
        );
      ...
      value: function formatString(str) {
        ...
        for (
          var _len = arguments.length,
            valuesForPlaceholders = Array(_len > 1 ? _len - 1 : 0),
            _key = 1;
          _key < _len;
          _key++
        ) {
          ...
          .map(function (textPart) {
            if (textPart.match(placeholderReplaceRegex)) {
              ...
              if (valueForPlaceholder === undefined) {
                var valueFromObjectPlaceholder =
