...
function Skeleton({
  ...
  const inline =
    (_a = styleOptions.inline) !== null && _a !== void 0 ? _a : false;
  const elements = [];
  ...
  for (let i = 0; i < countCeil; i++) {
    ...
    if (countCeil > count && i === countCeil - 1) {
      ...
      // original width.
      const width =
        (_b = thisStyle.width) !== null && _b !== void 0 ? _b : "100%"; // 100% is the default since that's what's in the CSS
    ...
    const skeletonSpan = React.createElement(
      "span",
      { className: className, style: thisStyle, key: i },
      "\u200C"
    );
    if (inline) {
  ...
  return React.createElement(
    "span",
    {
      ...
      "aria-live": "polite",
      "aria-busy":
        (_c = styleOptions.enableAnimation) !== null && _c !== void 0
          ? _c
          : defaultEnableAnimation,
    },
    Wrapper
