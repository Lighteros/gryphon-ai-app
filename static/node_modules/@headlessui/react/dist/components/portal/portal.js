...
import { useServerHandoffComplete as F } from "../../hooks/use-server-handoff-complete.js";
import {
  optionalRef as U,
  useSyncRefs as P,
} from "../../hooks/use-sync-refs.js";
import { usePortalRoot as D } from "../../internal/portal-force-root.js";
import { env as C } from "../../utils/env.js";
import { forwardRefWithAs as m, useRender as d } from "../../utils/render.js";
function N(u) {
  let r = D(),
    n = T(v),
    e = _(u),
...
function te() {
  let u = T(y),
    r = A([]),
    n = L((l) => (r.current.push(l), u && u.register(l), () => e(l))),
    e = L((l) => {
      let p = r.current.indexOf(l);
      p !== -1 && r.current.splice(p, 1), u && u.unregister(l);
    }),
    o = c(() => ({ register: n, unregister: e, portals: r }), [n, e, r]);
  return [
    r,
    c(
      () =>
        function ({ children: p }) {
          return f.createElement(y.Provider, { value: o }, p);
        },
      [o]
    ),
  ];
...
let J = m(j),
  X = m(I),
  re = Object.assign(J, { Group: X });
export { re as Portal, X as PortalGroup, te as useNestedPortals };
