...
import { useOnUnmount as V } from "../../hooks/use-on-unmount.js";
...
import { forwardRefWithAs as Q, useRender as Y } from "../../utils/render.js";
function U(o) {
  if (!o) return new Set();
  ...
  let R = z(),
    g = A((c) => {
      ...
      ((G) => G())(() => {
        h(R.current, {
          [H.Forwards]: () => {
            E(m, T.First, { skipElements: [c.relatedTarget, a] });
          },
          [H.Backwards]: () => {
            E(m, T.Last, { skipElements: [c.relatedTarget, a] });
          },
        });
      });
    }),
  ...
  K(
    ...
    (u) => {
      ...
      i && i instanceof HTMLElement
        ? I(f, i)
          ? ((s.current = i), p(i))
          : (u.preventDefault(), u.stopPropagation(), p(l))
        : p(s.current);
    },
    !0
  );
...
export { ye as FocusTrap, x as FocusTrapFeatures };
