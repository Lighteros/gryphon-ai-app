...
import {
  transitionDataAttributes as Se,
  useTransition as Re,
} from "../../hooks/use-transition.js";
import {
  OpenClosedProvider as ye,
  State as x,
  useOpenClosed as se,
...
import {
  RenderFeatures as xe,
  RenderStrategy as P,
  compact as Ne,
  forwardRefWithAs as J,
  useRender as ae,
...
function Ae(e, t) {
  ...
  let {
    ...
    { show: u, appear: z, initial: K } = De(),
    [v, G] = V(u ? "visible" : "hidden"),
    Q = He(),
  ...
  D(() => A(r), [A, r]),
    D(() => {
      if (H === P.Hidden && r.current) {
        ...
        return le(v, { ["hidden"]: () => I(r), ["visible"]: () => A(r) });
      }
    }, [v, r, A, I, u, H]);
  let B = re();
  D(() => {
...
function Ie(e, t) {
  ...
  let c = se();
  if (
    (n === void 0 && c !== null && (n = (c & x.Open) === x.Open), n === void 0)
  )
    throw new Error(
      "A <Transition /> is used but it is missing a `show={true | false}` prop."
    );
  let [C, h] = V(n ? "visible" : "hidden"),
    g = Te(() => {
      n || h("hidden");
    }),
    [o, i] = V(!0),
  ...
  D(() => {
    o !== !1 &&
      ...
      (a.current.push(n), i(!1));
  }, [a, n]);
  let s = ie(() => ({ show: n, appear: l, initial: o }), [n, l, o]);
  D(() => {
...
function Le(e, t) {
  ...
  return m.createElement(
    ...
    null,
    !n && l
      ? m.createElement(X, { ref: t, ...e })
      : m.createElement(me, { ref: t, ...e })
  );
}
let X = J(Ie),
  me = J(Ae),
...
export { ze as Transition, Fe as TransitionChild };
