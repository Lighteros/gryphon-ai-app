...
function R(p, f, C) {
      ...
      function (e, n) {
        ...
        for (let l of h)
          if (
            ...
            return;
        return (
          !M(r, y.Loose) && r.tabIndex !== -1 && e.preventDefault(),
          m.current(e, r)
        );
      },
      [m, f]
  ...
  c(
    ...
    c(
      ...
      "click",
      (t) => {
        g() || (i.current && (s(t, () => i.current), (i.current = null)));
      },
      !0
    );
  let a = d({ x: 0, y: 0 });
  c(
    ...
    c(
      ...
      (t) => {
        ...
        if (
          !(
            Math.abs(e.x - a.current.x) >= E || Math.abs(e.y - a.current.y) >= E
          )
        )
          return s(t, () =>
