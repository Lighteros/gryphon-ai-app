...
function C({
  ...
  if (y & 1) {
    ...
    return M(f ? 0 : 1, {
      ...
      [1]() {
        return F({ ...u, hidden: !0, style: { display: "none" } }, e, a, l, i);
      },
    });
  }
  return F(o, e, a, l, i);
...
function F(n, r = {}, e, a, s) {
  ...
  if (t === b && (Object.keys(m(o)).length > 0 || Object.keys(m(u)).length > 0))
    if (!w(f) || (Array.isArray(f) && f.length > 1)) {
...
`)
      ...
      return j(f, Object.assign({}, g, u, y, { ref: s(H(f), y.ref) }, T));
    }
