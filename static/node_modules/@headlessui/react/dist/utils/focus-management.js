import { disposables as N } from "./disposables.js";
...
function A(e, r = 0) {
  var t;
  return e === ((t = E(e)) == null ? void 0 : t.body)
    ? !1
    : L(r, {
        [0]() {
          return e.matches(f);
...
function O(e) {
  var r, t;
  return (t =
    (r = e == null ? void 0 : e.matches) == null ? void 0 : r.call(e, w)) !=
    null
    ? t
    : !1;
}
...
export {
  ...
  S as getAutoFocusableElements,
  b as getFocusableElements,
  A as isFocusableElement,
  G as restoreFocusIfNecessary,
  _ as sortByDomNode,
};
